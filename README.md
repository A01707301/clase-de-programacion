## Calculadora de física de fuerzas

# Mi calculadora de física va a poder hacer 3 acciones diferentes. Usar un formulario, resolver una ecuación y hacer conversion de unidades. Cada una de las acciones despliegan diferentes acciones más para poder tener una calculadora completa. Se me hace interesante este proyecto porque creo que es necesario poder tener una calculadora de fìsica que logra facilitar todo y se pueda hacer diversas cosas en un solo lugar.

# Primero tengo que definir todas las ecuaciones que se van a realizar
...
# Se pregunta primero para que van a usar la calculadora
...
Dependiendo de lo que s enecesite, se ingresa un nùmero y se realiza la acción.
